...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="gambar/icone.png">
...
<nav class="navbar navbar-expand-lg shadow-sm fixed-top" style="background-color: var(--bs-body-bg);">
  <div class="container">
    <a class="navbar-brand" href="#"><img src="gambar/logoNav.png" width="50px"></a>
...
<section class="jumbotron text-center" style="margin-top: 76px;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href="https://garuda-id.kitagaruda.id/registration?step=1">
    ...
    <div class="carousel-item">
      <img src="gambar/jumbotron2.jpeg" class="d-block w-100" alt="Gambar 2 Jumbotron">
    </div>
    <div class="carousel-item">
      <img src="gambar/jumbotron3.jpg" class="d-block w-100" alt="Gambar 3 Jumbotron">
    </div>
  </div>
      ...
      ?>
        <div class="col">
          <div class="card h-100">
            <img src="gambar/<?= $row["gambar"]?>" class="card-img-top" alt="Gambar Berita"/>
            <div class="card-body">
...
<section id="gallery">
  ...
  <div class="carousel-inner mb-5">
    <div class="carousel-item active">
      <img src="https://pbs.twimg.com/media/GZ7mpR3aQAEjeaT?format=jpg&name=large" class="d-block w-100" alt="Gambar 1 Gallery">
    </div>
    <div class="carousel-item">
      <img src="https://pbs.twimg.com/media/GZ_TuuLaMAAVAKI?format=jpg&name=large" class="d-block w-100" alt="Gambar 2 Gallery">
    </div>
    <div class="carousel-item">
      <img src="https://pbs.twimg.com/media/GW9oX5pbUAAx3jU?format=jpg&name=large" class="d-block w-100" alt="Gambar 3 Gallery">
    </div>
    <div class="carousel-item">
      <img src="https://pbs.twimg.com/media/GXBUW-gbMAAQAdf?format=jpg&name=large" class="d-block w-100" alt="Gambar 4 Gallery">
    </div>
  </div>
